...
cd "$(dirname "$0")"
fail=0
for t in test_guide.lua test_engine.lua test_movement.lua test_world.lua test_physical.lua test_behaviour.lua test_lifecycle.lua test_bootstrap.lua; do
  echo ""
  echo "=================== $t ==================="
