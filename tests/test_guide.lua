...
check(Diplomacy.default_standing("bandit_gang", "bandit_gang") == 0,
      "kahden rosvojoukon suhde ei ole automaattisesti vihamielinen")
check(Diplomacy.default_standing("police_patrol", "hunters") == 0,
      "muut oletussuhteet ovat 0")
